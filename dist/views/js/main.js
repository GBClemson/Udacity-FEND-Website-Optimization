...
2) Reduced the number of bg pizzas being generated from 200 to 24. Realigned the vertical positions to match the users display.
...
6) Went back into resizePizzas function and made dramatic simplification to the pizza slider calculations:
    Completely did away with determineDx and just used the slider to generate a new width for the pizza.png image. This method allows
    us to completely ignore the old size and just make each element the new size based on the slider position.
*/
...
var resizePizzas = function(size) {
  ...
  // Changes the value of pizza.png to a new pixel width
